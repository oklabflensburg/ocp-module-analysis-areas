...
- [x] Wikidata lookup, matching, refresh, manual assignment and its stable
  `analysis-areas.wikidata-refresh` job are module-owned and use public DB, HTTP,
  cache, settings, service-registry and observability ports.
